  ...
  let data = JSON.stringify([
      {
          ...
          "custom_fields_values": [
              {
                  "field_id": "product_list", 
                  "values": [
                      { "value": shopifydata.products }
                  ]
              }
          ],
...
let config = {
  ...
  headers: { 
    ...
    'Cookie': 'session_id=2g23da77asutmq8h1eu5vsab1o; user_lang=en'
  },
  data : data
};
...
try {
  ...
  console.log('Respuesta de Kommo:', JSON.stringify(response.data));
} catch (error) {
  console.log('Error al enviar datos a Kommo:', error);
}
}
